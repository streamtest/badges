        ...
        jQuery("iframe").each(function (index, element) {
            ...
            if (src) {
            	...
            	if (src.indexOf("youtube") != -1 || src.indexOf("vimeo") != -1)
                	var button = jQuery(element).after("<a style='text-decoration: none !important;' href=//www.streamtest.net/#test?streamUrl=" + src + " target='_blank'><svg class='streamButton'><text id='start' class='tabButton' x='45px' y='68%' fill='url(#pattern)'>Test this Stream</text><defs><linearGradient id='gradient' x1='0%' y1='0%' x2='100%' y2='0'><stop offset='0%' style='stop-color:#000;'/><stop offset='20%' style='stop-color:#fb3c4a;'/><stop offset='30%' style='stop-color:#fff;'/><stop offset='50%' style='stop-color:#fff;'/><stop offset='100%' style='stop-color:#000;'/></linearGradient><pattern id='pattern' x='0' y='0' width='300%' height='100%' patternUnits='userSpaceOnUse'><rect x='0' y='0' width='150%' height='100%' fill='url(#gradient)'><animate attributeName='x' from='0' to='150%' dur='4s' begin='start.mouseover' repeatCount='2'/></rect><rect x='-150%' y='0' width='150%' height='100%' fill='url(#gradient)'><animate attributeName='x'from='-150%' to='0' dur='4s' begin='start.mouseover' repeatCount='2'/></rect></pattern></defs></svg></a>");
