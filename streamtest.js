    ...
    jQuery(document).ready(function () {
        ...
        jQuery("iframe").each(function (index, element) {
            ...
            if (src) {
            	...
            	var leftMargin = parseInt(jQuery(element).position.left);
