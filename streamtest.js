...
include("https://netrodev.github.io/streamtest-badge/streamtestbadge.css", "css");
        ...
        jQuery("object").each(function (index, element) {
            ...
            if (type === "application/x-shockwave-flash") {
                ...
                if (flashBaseUrlMatches && flashUrlMatches) {
                    ...
                    jQuery(element).after("<a href=//www.streamtest.net/#test?streamUrl=" + sanitizedUrl + " target='_blank'><button class='tabButton'>Test Stream</button></a>")
                }
            }
        });
    });
